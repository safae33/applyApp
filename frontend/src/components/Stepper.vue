            ...
            <v-row justify="center">
              ...
              <v-card elevation="6" width="95%" class="mt-5 mb-5">
                ...
                <v-card-text width="100%">
                  <v-row>
                    <v-col cols="12" xl="6" lg="6" md="6" sm="6">
                      <v-textarea label="Adres*" counter="250" outlined :rules="rules.address"></v-textarea>
                    </v-col>
                    <v-col cols="12" xl="6" lg="6" md="6" sm="6">
                      <v-row>
      ...
      <v-stepper-content step="2">
        <v-row justify="center">
          <v-card elevation="6" width="95%" class="mt-2 mb-5 text-center">
            ...
            <v-card-text width="100%" class="mb-5">
              ...
              <transition-group name="fade">
                <v-row v-for=" i of staffLength" :key="i">
                  <v-col cols="12" xl="3" lg="3" md="3" sm="6">
                    <v-text-field
                      :rules="rules.general"
                      hide-details="auto"
          ...
          <v-col cols="6" class="text-right">
                    <v-chip class="mr-2" @click="staffLength--">
                      <v-icon color="black" left>mdi-minus</v-icon>Personel Çıkar
                    </v-chip>
                  </v-col>
                  
          <v-col cols="6" class="text-left">
            <v-chip class="mr-2" @click="staffLength++">
              <v-icon color="black" left>mdi-plus</v-icon>Personel Ekle
            </v-chip>
          </v-col>

          <v-col cols="12" class="text-center ml-8">
            <v-checkbox
              color="myColor"
              v-model="finalCheck"
              label="Formda yer alan bilgilerin doğruluğunu, hatalı bilgilerden doğacak sorumluluğun tarafıma ait olduğunu, kabul ve beyan ederim."
            ></v-checkbox>
          </v-col>
